...
const footerStr = `Released under the MIT License. Copyright © {{idocYear}} Zehao Lu<br />Generated by <a href="https://github.com/jaywcjlove/idoc" target="_blank">idoc</a> v{{idocVersion}}`;
